                ...
                <div id="formats" class="collapse in">
                    <div class="row">
                        <div class="col-xs-6 col-5">
                            ...
                            <a class="download pull-right" href="https://www.tobeflash.com/wp-content/uploads/2017/09/Gabarit-2017_WEB-FLYER-A4.pdf" class="pull-right">
                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i> <?php pll_e('Télécharger le gabarit'); ?>
                            </a>
                        </div>
                        ...
                        <div class="col-xs-6 col-5">
                            ...
                            <a class="download pull-right" href="https://www.tobeflash.com/wp-content/uploads/2017/09/Gabarit-2017_WEB-FLYER-A5.pdf" class="pull-right">
                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i> <?php pll_e('Télécharger le gabarit'); ?>
                            </a>
                        </div>
                        ...
                        <div class="col-xs-6 col-5">
                            ...
                            <a class="download pull-right" href="https://www.tobeflash.com/wp-content/uploads/2017/09/Gabarit-2017_WEB-FLYER-AllongÇ_100x210.pdf" class="pull-right">
                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i> <?php pll_e('Télécharger le gabarit'); ?>
                            </a>
                        </div>
                        ...
                        <div class="col-xs-6 col-5">
                            ...
                            <a class="download pull-right" href="https://www.tobeflash.com/wp-content/uploads/2017/09/Gabarit-2017_WEB-FLYER-Carre_194-x-194.pdf" class="pull-right">
                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i> <?php pll_e('Télécharger le gabarit'); ?>
                            </a>
                        </div>
                        ...
                        <div class="col-xs-6 col-5">
                            ...
                            <a class="download pull-right" href="https://www.tobeflash.com/wp-content/uploads/2017/09/Gabarit-2017_WEB-FLYER-A6.pdf" class="pull-right">
                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i> <?php pll_e('Télécharger le gabarit'); ?>
                            </a>
                        </div>
